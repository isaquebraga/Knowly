# [Sailer; Homner, 2020] — Meta-análise da gamificação na aprendizagem
...
**Base / localização (DOI ou link):** SpringerLink — DOI: 10.1007/s10648-019-09498-w

**Eixo(s) temático(s):** E5 — Gamificação, rankings e motivação

**Questão(ões) de revisão relacionada(s):** QR5; QR6

**Tipo de estudo e método:** Meta-análise de estudos empíricos sobre gamificação na aprendizagem, com análise de moderadores.

**Contexto e participantes:** Estudos em contextos educacionais e de treinamento diversos.
...
**Limitações apontadas:** Heterogeneidade entre estudos e predominância de intervenções curtas; os próprios autores recomendam cautela na generalização e mais estudos longitudinais.

**Relevância para o projeto (alta / média / baixa):** Alta

**Responsável e data do fichamento:** Isaque — agosto de 2026
